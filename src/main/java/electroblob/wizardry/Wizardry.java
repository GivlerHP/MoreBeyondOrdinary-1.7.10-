...
public class Wizardry {
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		List<Item> orderedItemList = Arrays.asList(
				...
				magicCrystal, magicWand, apprenticeWand, advancedWand, masterWand, arcaneTome,
	...
	private static void setupGeneralConfig(){
		...
		property = config.get(Wizardry.IDS_CATEGORY, "magicSwordEnchantmentID", 130, "The ID of the magic sword enchantment. Change if this conflicts with another mod.", 63, 255);
		property.setLanguageKey("config.magic_sword_enchantment_id");
		property.setRequiresMcRestart(true);
		magicSwordEnchantmentID = property.getInt();
		propOrder2.add(property.getName());
		
		property = config.get(Wizardry.IDS_CATEGORY, "magicBowEnchantmentID", 131, "The ID of the magic bow enchantment. Change if this conflicts with another mod.", 63, 255);
		property.setLanguageKey("config.magic_bow_enchantment_id");
		property.setRequiresMcRestart(true);
		magicBowEnchantmentID = property.getInt();
		propOrder2.add(property.getName());
		
		property = config.get(Wizardry.IDS_CATEGORY, "flamingWeaponEnchantmentID", 132, "The ID of the flaming weapon enchantment. Change if this conflicts with another mod.", 63, 255);
		property.setLanguageKey("config.flaming_weapon_enchantment_id");
		property.setRequiresMcRestart(true);
		flamingWeaponEnchantmentID = property.getInt();
		propOrder2.add(property.getName());
		
		property = config.get(Wizardry.IDS_CATEGORY, "freezingWeaponEnchantmentID", 133, "The ID of the freezing weapon enchantment. Change if this conflicts with another mod.", 63, 255);
