...
public class ModelSpiritHorse extends ModelBase
{
    ...
    private ModelRenderer frontRightLegBox ;
    ...
    public ModelSpiritHorse()
    {
        ...
        this.frontRightLegBox  = new ModelRenderer(this, 44, 29);
        this.frontRightLegBox .addBox(-1.9F, -1.0F, -2.1F, 3, 8, 4);
        this.frontRightLegBox .setRotationPoint(4.0F, 9.0F, -8.0F);
    ...
    public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        this.frontRightLegBox.render(par7);
    ...
    public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
    {
        ...
        this.frontRightLegBox .rotationPointY = -2.0F * f9 + 9.0F * f10;
        this.frontRightLegBox .rotationPointZ = -2.0F * f9 + -8.0F * f10;
        this.field_110684_D.rotationPointY = this.frontRightLegBox.rotationPointY;
        this.field_110684_D.rotationPointZ = this.frontRightLegBox.rotationPointZ;
        ...
        this.frontLeftShin.rotationPointY = this.frontRightLegBox.rotationPointY + MathHelper.sin(((float)Math.PI / 2F) + f20) * 7.0F;
        this.frontLeftShin.rotationPointZ = this.frontRightLegBox.rotationPointZ + MathHelper.cos(((float)Math.PI * 3F / 2F) + f20) * 7.0F;
        ...
        this.frontRightLegBox.rotateAngleX = f20;
        this.frontLeftShin.rotateAngleX = (this.frontRightLegBox.rotateAngleX + (float)Math.PI * Math.max(0.0F, 0.2F + f19 * 0.2F)) * f9 + (f14 + Math.max(0.0F, f13 * 0.5F * par3)) * f10;
