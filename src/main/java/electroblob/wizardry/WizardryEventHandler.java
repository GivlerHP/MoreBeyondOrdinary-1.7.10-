...
public class WizardryEventHandler {
	...
	public void onLivingDropsEvent(LivingDropsEvent event){
		...
		if(event.entityLiving instanceof EntityMob && event.source.getEntity() instanceof EntityPlayer && !(event.source.getEntity() instanceof FakePlayer) && Wizardry.spellBookDropChance > 0){
