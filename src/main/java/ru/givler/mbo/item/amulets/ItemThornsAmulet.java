...
public class ItemThornsAmulet extends ItemAmuletBase {
    public ItemThornsAmulet(String name, String texture) {
    ...
    public void activate(EntityPlayer player, ItemStack stack) {
        player.addPotionEffect(new PotionEffect(PotionRegistry.Thorns.id, 200, 2));
    }
