...
public class ItemStrengthAmulet extends ItemAmuletBase {

    public ItemStrengthAmulet(String name, String texture) {
    ...
    public void activate(EntityPlayer player, ItemStack stack) {
        player.addPotionEffect(new PotionEffect(PotionRegistry.MeleeDamage.id, 200, 0));
