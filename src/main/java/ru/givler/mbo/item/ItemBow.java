...
public class ItemBow extends net.minecraft.item.ItemBow {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        icons[0] = iconRegister.registerIcon(MoreBeyondOrdinary.MODID + ":" + texture + "_standart");
        for (int i = 1; i < 4; i++) {
            icons[i] = iconRegister.registerIcon(MoreBeyondOrdinary.MODID + ":" + texture + "_pulling_" + (i-1));
        }
    }
