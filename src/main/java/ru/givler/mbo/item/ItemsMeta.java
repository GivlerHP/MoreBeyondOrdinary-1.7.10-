...
public class ItemsMeta extends Item {
    ...
    public ItemsMeta(String name, String texture, int maxStackSize, int count) {
        this.count = count;
    ...
    public void registerIcons(IIconRegister register) {
        ...
        for (int i = 0; i < this.count; ++i) {
            this.icon[i] = register.registerIcon(main.MODID + ":" + this.textureBase + "_" + i);
        }
    }
