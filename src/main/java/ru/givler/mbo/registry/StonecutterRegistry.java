...
import ru.givler.mbo.block.craft.BlockStonecutter;
...
public final class StonecutterRegistry {
  ...
  /**
   * Central place for built-in stonecutter recipes. Add addon recipes through
   * StonecutterRecipes.add.
   */
  public static void registerRecipes() {
    GameRegistry.addRecipe(
        new ItemStack(stonecutter), " I ", "SSS", 'I', Items.iron_ingot, 'S', Blocks.stone);
    ...
    StonecutterRecipes.add(
        new ItemStack(BlockRegistry.SmoothStone), new ItemStack(BlockRegistry.SlabSmoothStone, 2));
    StonecutterRecipes.add(
        new ItemStack(BlockRegistry.SmoothStone), new ItemStack(BlockRegistry.StairsSmoothStone));
    StonecutterRecipes.add(
        new ItemStack(BlockRegistry.SmoothStone), new ItemStack(BlockRegistry.WallSmoothStone));

    add(
        new ItemStack(BlockRegistry.BlockSandstone, 1, 0),
    ...
    add(
        new ItemStack(BlockRegistry.BlockGreyStone),
        new ItemStack(BlockRegistry.BlockStonebrick, 1, 0));
    add(
        new ItemStack(BlockRegistry.BlockGreyStone),
        new ItemStack(BlockRegistry.BlockStonebrick, 1, 3));
    addMboFamily(
        BlockRegistry.BlockGreyStone,
        BlockRegistry.SlabStone,
        BlockRegistry.StairsStone,
        BlockRegistry.WallStonebrick);
    addMboFamily(
        BlockRegistry.BlockGreyCobblestone,
        BlockRegistry.SlabCobblestone,
        BlockRegistry.StairsGreyCobblestone,
        null);
    addMboFamily(
        BlockRegistry.BlockStonebrick,
        BlockRegistry.SlabStonebrick,
        BlockRegistry.StairsStonebrick,
        BlockRegistry.WallStonebrick);
    addMboFamily(
        BlockRegistry.BlockSandstone,
        BlockRegistry.SlabSandstone,
        BlockRegistry.StairsSandstone,
        BlockRegistry.WallSandstone);
    addMboFamily(
        BlockRegistry.BlockIrgadBrick,
        BlockRegistry.SlabIrgadBrick,
        BlockRegistry.StairsIrgadBrick,
        null);
    addMboFamily(
        BlockRegistry.BlockEndbrick,
        BlockRegistry.SlabEndbrick,
        BlockRegistry.StairsEndbrick,
        null);
    addMboFamily(
        BlockRegistry.BlockImperialBrick,
        BlockRegistry.SlabImperialBrick,
        BlockRegistry.StairsImperialBrick,
        null);
    addMboFamily(
        BlockRegistry.BlockHeneizenBrick,
        BlockRegistry.SlabHeneizenBrick,
        BlockRegistry.StairsHeneizenBrick,
        null);
    addMboFamily(
        BlockRegistry.BlockFiredClay,
        BlockRegistry.SlabFiredClay,
        BlockRegistry.StairsFiredClay,
        BlockRegistry.WallFiredClay);
    addMboFamily(
        BlockRegistry.BlockAshgarBrick,
        BlockRegistry.SlabAshgarBrick,
        BlockRegistry.StairsAshgarBrick,
        BlockRegistry.WallAshgarBrick);
  ...
  private static void addFamily(
      ItemStack input, ItemStack variant, ItemStack slab, ItemStack stairs) {
  ...
  private static void addMboFamily(
