...
public class CreativeTabRegistry {
  public static final CreativeTabs tabMBOblocks =
      new CreativeTabs("MBOblocks") {
        ...
        public void displayAllReleventItems(List list) {
          ...
          for (int i = 0; i <= 3; i++) {
            list.add(new ItemStack(BlockStonebrick, 0, i));
          }
          ...
          for (int i = 0; i <= 2; i++) {
            list.add(new ItemStack(BlockSandstone, 0, i));
          }
          ...
          for (int i = 0; i <= 5; i++) {
            list.add(new ItemStack(RoofWood, 1, i));
          }
          for (int i = 0; i <= 5; i++) {
            list.add(new ItemStack(StairsRoofWood[i]));
          }
          for (int i = 0; i <= 5; i++) {
            list.add(new ItemStack(SlabRoofWood[i]));
          }

          for (int i = 0; i <= 2; i++) {
            list.add(new ItemStack(RoofUnfired, 1, i));
          }
          for (int i = 0; i <= 2; i++) {
            list.add(new ItemStack(RoofStandart, 1, i));
          }
          for (int i = 0; i <= 2; i++) {
            list.add(new ItemStack(StairsRoofStandart[i]));
          }
          for (int i = 0; i <= 2; i++) {
            list.add(new ItemStack(SlabRoofStandart[i]));
          }

          for (int i = 0; i <= 15; i++) {
            list.add(new ItemStack(RoofLaminated, 1, i));
          }
          for (int i = 0; i <= 15; i++) {
            list.add(new ItemStack(StairsRoofLaminated[i]));
          }
          for (int i = 0; i <= 15; i++) {
            list.add(new ItemStack(SlabRoofLaminated[i]));
          }

          for (int i = 0; i <= 15; i++) {
            list.add(new ItemStack(RoofSheet, 1, i));
          }
          for (int i = 0; i <= 15; i++) {
            list.add(new ItemStack(StairsRoofSheet[i]));
          }
          for (int i = 0; i <= 15; i++) {
            list.add(new ItemStack(SlabRoofSheet[i]));
          }

          for (int i = 0; i <= 15; i++) {
            list.add(new ItemStack(RoofFlake, 1, i));
          }
          for (int i = 0; i <= 15; i++) {
            list.add(new ItemStack(StairsRoofFlake[i]));
          }
          for (int i = 0; i <= 15; i++) {
            list.add(new ItemStack(SlabRoofFlake[i]));
          }
        }
      };
  ...
  private static void addOptionalBoPCreativeItems(List list) {
    ...
    try {
      Class.forName("ru.givler.mbo.integration.biomesoplenty.BiomesOPlentyRegistry")
          .getMethod("addCreativeItems", List.class)
          .invoke(null, list);
  ...
  public static final CreativeTabs tabMBOitems =
      new CreativeTabs("MBOitems") {
        @Override
        public Item getTabIconItem() {
          return WeaponRapier;
        }
        ...
        public void displayAllReleventItems(List list) {
          ...
          for (int i = 0; i <= 0; i++) {
            list.add(new ItemStack(Metal, 0, i));
          }
          list.add(new ItemStack(SapphireEye));
          list.add(new ItemStack(SapphireHeart));
          for (int i = 0; i <= 3; i++) {
            list.add(new ItemStack(Drop, 0, i));
          }
          for (int i = 0; i <= 14; i++) {
            list.add(new ItemStack(Crystall, 0, i));
          }
          ...
          for (int i = 0; i <= 5; i++) {
            list.add(new ItemStack(vanillaBoats, 1, i));
          }
          for (int i = 0; i <= 5; i++) {
            list.add(new ItemStack(vanillaChestBoats, 1, i));
          }
  ...
  public static final CreativeTabs tabMBOfoods =
      new CreativeTabs("MBOfoods") {
        @Override
        public Item getTabIconItem() {
          return DrinkWine;
        }
  ...
  public static final CreativeTabs tabMBOdecors =
      new CreativeTabs("MBOdecors") {
        @Override
        public Item getTabIconItem() {
