...
public class DrinkRegistry {
  public static Item DrinkWine,
      ...
      DrinkTincure,
      DrinkBreathWyvern,
      DrinkBeer; // переменные для напитков и зелий

  @Mod.EventHandler
  public static void preLoad(FMLPreInitializationEvent event) {
    // НИЖЕ НАХОДИТСЯ НАПИТКИ
    DrinkWine =
        new ItemDrink("DrinkWine", "drink/drink_wine")
    ...
    DrinkCider =
        new ItemDrink("DrinkCider", "drink/drink_cider")
