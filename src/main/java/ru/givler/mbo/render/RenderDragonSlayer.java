...
public class RenderDragonSlayer implements IItemRenderer {
    private final float scale;

    public RenderDragonSlayer(float scale) {
        this.scale = scale;
    }
    ...
    private void renderEquippedItem(ItemStack stack, EntityLivingBase entity, boolean firstPerson) {
        ...
        if (firstPerson) {
            ...
            f *= (entity instanceof EntityPlayer ? 1.0F : 1.0F);
            GL11.glTranslatef(-0.68F, -0.10F, 0.01F);
        }
