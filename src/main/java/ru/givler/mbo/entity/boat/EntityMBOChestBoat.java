...
public class EntityMBOChestBoat extends EntityMBOBoat implements IInventory {
  ...
  public EntityMBOChestBoat(World world) {
    super(world);
  }
  ...
  protected ItemStack getBoatDrop() {
    ...
    return new ItemStack(
        bop ? BoatRegistry.bopChestBoats : BoatRegistry.vanillaChestBoats,
        1,
  ...
  public String getInventoryName() {
    return "container.mbo.chest_boat";
  }
  ...
  public void setDead() {
    if (!worldObj.isRemote && dropContents) {
      for (ItemStack stack : contents) {
        if (stack != null)
          worldObj.spawnEntityInWorld(new EntityItem(worldObj, posX, posY, posZ, stack.copy()));
      }
    }
    super.setDead();
  }
