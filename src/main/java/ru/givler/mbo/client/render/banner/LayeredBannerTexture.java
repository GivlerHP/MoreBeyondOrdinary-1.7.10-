...
public class LayeredBannerTexture extends AbstractTexture {
  ...
  public LayeredBannerTexture(
      ResourceLocation base, List<ResourceLocation> layers, List<Integer> colors) {
    this.base = base;
    this.layers = layers;
    this.colors = colors;
  }
  ...
  public void loadTexture(IResourceManager manager) throws IOException {
    ...
    BufferedImage result =
        new BufferedImage(
            baseImage.getWidth(), baseImage.getHeight(), BufferedImage.TYPE_4BYTE_ABGR);
  ...
  private BufferedImage read(IResourceManager manager, ResourceLocation location)
      throws IOException {
