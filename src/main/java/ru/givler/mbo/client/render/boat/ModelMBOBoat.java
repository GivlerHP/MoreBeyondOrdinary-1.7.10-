...
public class ModelMBOBoat extends ModelBase {
  ...
  public ModelMBOBoat() {
    ...
    parts[0].addBox(-14, -9, -3, 28, 16, 3);
    parts[0].setRotationPoint(0, 3, 1);
    parts[1].addBox(-13, -7, -1, 18, 6, 2);
    parts[1].setRotationPoint(-15, 4, 4);
    parts[2].addBox(-8, -7, -1, 16, 6, 2);
    parts[2].setRotationPoint(15, 4, 0);
    parts[3].addBox(-14, -7, -1, 28, 6, 2);
    parts[3].setRotationPoint(0, 4, -9);
    parts[4].addBox(-14, -7, -1, 28, 6, 2);
    parts[4].setRotationPoint(0, 4, 9);
    ...
    parts[5] = paddle(true);
    parts[5].setRotationPoint(3, -5, 9);
    parts[6] = paddle(false);
    parts[6].setRotationPoint(3, -5, -9);
