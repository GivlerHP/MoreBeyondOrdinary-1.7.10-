...
public final class RenderLadderBlock implements ISimpleBlockRenderingHandler {
  ...
  public RenderLadderBlock(int renderId) {
  ...
  private static double[] uv(double a, double b, double c, double d) {
  ...
  private static void face(
    ...
    put(t, meta, wx, wy, wz, p[0], p[1], p[2], u1, v2);
    put(t, meta, wx, wy, wz, p[3], p[4], p[5], u2, v2);
    put(t, meta, wx, wy, wz, p[6], p[7], p[8], u2, v1);
    put(t, meta, wx, wy, wz, p[9], p[10], p[11], u1, v1);
  }
