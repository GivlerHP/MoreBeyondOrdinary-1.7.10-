...
public class RenderSlimeBlock implements ISimpleBlockRenderingHandler {
  ...
  public RenderSlimeBlock(int renderId) {
  ...
  private void renderCube(
    ...
    t.startDrawingQuads();
    t.setNormal(0, -1, 0);
    r.renderFaceYNeg(block, 0, 0, 0, block.getIcon(0, meta));
    t.draw();
    t.startDrawingQuads();
    t.setNormal(0, 1, 0);
    r.renderFaceYPos(block, 0, 0, 0, block.getIcon(1, meta));
    t.draw();
    t.startDrawingQuads();
    t.setNormal(0, 0, -1);
    r.renderFaceZNeg(block, 0, 0, 0, block.getIcon(2, meta));
    t.draw();
    t.startDrawingQuads();
    t.setNormal(0, 0, 1);
    r.renderFaceZPos(block, 0, 0, 0, block.getIcon(3, meta));
    t.draw();
    t.startDrawingQuads();
    t.setNormal(-1, 0, 0);
    r.renderFaceXNeg(block, 0, 0, 0, block.getIcon(4, meta));
    t.draw();
    t.startDrawingQuads();
    t.setNormal(1, 0, 0);
    r.renderFaceXPos(block, 0, 0, 0, block.getIcon(5, meta));
    t.draw();
  }
