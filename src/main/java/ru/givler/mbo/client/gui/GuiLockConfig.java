...
public class GuiLockConfig extends GuiScreen {
  ...
  protected void actionPerformed(GuiButton button) {
    if (button.id == 1) {
      ...
      PacketManager.INSTANCE.sendToServer(
          new PacketLockBarrierSettings(x, y, z, difficulty, delay, radius));
  ...
  protected void mouseClicked(int mx, int my, int button) {
    ...
    delayField.mouseClicked(mx, my, button);
    radiusField.mouseClicked(mx, my, button);
  }
  ...
  public void drawScreen(int mx, int my, float partial) {
    ...
    drawCenteredString(
        fontRendererObj,
        I18n.format("mbo.lock.gui.settings"),
        width / 2,
        height / 2 - 78,
        0xffffff);
    fontRendererObj.drawString(
        I18n.format("mbo.lock.gui.autoClose.label"), width / 2 - 100, height / 2 - 29, 0xdddddd);
    fontRendererObj.drawString(
        I18n.format("mbo.lock.gui.playerRadius.label"), width / 2 - 100, height / 2 + 7, 0xdddddd);
