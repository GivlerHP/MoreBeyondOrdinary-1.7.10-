...
import ru.givler.mbo.client.PlatformEditorMouseHandler;
import ru.givler.mbo.client.MovingPlatformClientTickHandler;
...
public class ClientProxy extends CommonProxy {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityMovingPlatform.class, new RenderMovingPlatform());
        MinecraftForge.EVENT_BUS.register(new PlatformSelectionRenderer());
        MinecraftForge.EVENT_BUS.register(new PlatformEditorMouseHandler());
        FMLCommonHandler.instance().bus().register(new MovingPlatformClientTickHandler());
