...
public class PacketManager {
  ...
  public static void registerCommonPackets() {
    ...
    INSTANCE.registerMessage(
        ...
        Side.SERVER);
    INSTANCE.registerMessage(
        PacketBoatMove.Handler.class, PacketBoatMove.class, nextID++, Side.SERVER);
    INSTANCE.registerMessage(
        PacketLockpickPin.Handler.class, PacketLockpickPin.class, nextID++, Side.SERVER);
    INSTANCE.registerMessage(
        PacketLockOpenConfig.Handler.class, PacketLockOpenConfig.class, nextID++, Side.SERVER);
    INSTANCE.registerMessage(
        PacketSetLockDifficulty.Handler.class,
        PacketSetLockDifficulty.class,
        nextID++,
        Side.SERVER);
    INSTANCE.registerMessage(
        PacketLockpickSuccess.Handler.class, PacketLockpickSuccess.class, nextID++, Side.SERVER);
    INSTANCE.registerMessage(
        PacketLockLootSettings.Handler.class, PacketLockLootSettings.class, nextID++, Side.SERVER);
    INSTANCE.registerMessage(
        PacketLockBarrierSettings.Handler.class,
        PacketLockBarrierSettings.class,
        nextID++,
        Side.SERVER);
    INSTANCE.registerMessage(
        PacketApplyLockTemplate.Handler.class,
        PacketApplyLockTemplate.class,
        nextID++,
        Side.SERVER);
    INSTANCE.registerMessage(
        PacketGamemodeMenuRequest.Handler.class,
        PacketGamemodeMenuRequest.class,
        nextID++,
        Side.SERVER);
    INSTANCE.registerMessage(
    ...
    INSTANCE.registerMessage(
        ...
        Side.SERVER);
    INSTANCE.registerMessage(
        PacketDungeonEditorSettings.Handler.class,
        PacketDungeonEditorSettings.class,
        nextID++,
        Side.SERVER);
    INSTANCE.registerMessage(
        PacketDungeonAreaDelete.Handler.class,
        PacketDungeonAreaDelete.class,
        nextID++,
        Side.SERVER);
    INSTANCE.registerMessage(
        PacketDungeonAreaOpenRequest.Handler.class,
        PacketDungeonAreaOpenRequest.class,
        nextID++,
        Side.SERVER);
    INSTANCE.registerMessage(
        PacketDungeonTriggerSettings.Handler.class,
        PacketDungeonTriggerSettings.class,
        nextID++,
        Side.SERVER);
  }
  ...
  public static void registerClientPackets() {
    ...
    INSTANCE.registerMessage(
        PacketSpectatorState.Handler.class, PacketSpectatorState.class, nextID++, Side.CLIENT);
    INSTANCE.registerMessage(
        PacketGamemodeMenuPermission.Handler.class,
        PacketGamemodeMenuPermission.class,
        nextID++,
        Side.CLIENT);
    INSTANCE.registerMessage(
        PacketPlatformSync.Handler.class, PacketPlatformSync.class, nextID++, Side.CLIENT);
    INSTANCE.registerMessage(
        PacketPlatformOpen.Handler.class, PacketPlatformOpen.class, nextID++, Side.CLIENT);
    INSTANCE.registerMessage(
        PacketPlatformRemove.Handler.class, PacketPlatformRemove.class, nextID++, Side.CLIENT);
    INSTANCE.registerMessage(
        PacketDungeonEditorOpen.Handler.class,
        PacketDungeonEditorOpen.class,
        nextID++,
        Side.CLIENT);
    INSTANCE.registerMessage(
        PacketDungeonAreaSync.Handler.class, PacketDungeonAreaSync.class, nextID++, Side.CLIENT);
    INSTANCE.registerMessage(
        PacketDungeonTriggerOpen.Handler.class,
        PacketDungeonTriggerOpen.class,
        nextID++,
        Side.CLIENT);
    INSTANCE.registerMessage(
        PacketWaterloggedDelta.Handler.class, PacketWaterloggedDelta.class, nextID++, Side.CLIENT);
    INSTANCE.registerMessage(
        PacketWaterloggedSnapshot.Handler.class,
